...
namespace APIVerve
{
    public class SunPositionAPIClient
    {
        ...
        public SunPositionAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public SunPositionAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(sunpositionQueryOptions options)
        {
            try
            {
                if (_isDebug)
